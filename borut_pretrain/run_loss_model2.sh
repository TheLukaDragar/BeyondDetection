...
srun --nodes=2 --cpus-per-task=12 --gpus-per-node=4 -p gpu --ntasks-per-node=4 --exclusive python3 pretrain_timm_loss.py --devices 0 1 2 3 --num_nodes 2 --batch_size 4 --num_epochs 60 --model_name $model_name ${args[@]:1} 