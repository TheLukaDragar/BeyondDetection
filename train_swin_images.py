...
class Swin(pl.LightningModule):
    def __init__(self, og_path,model_name="swin_large_patch4_window12_384_in22k", dropout=0.1, loss="rmse", lr=2e-5,drop_path_rate=0.0,weight_decay=0.01):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--experiment_name",
        default="swin_large_patch4_window12_384_in22k_borut",
    ...
    model = Swin(
        og_path=og_path,
        model_name="swin_large_patch4_window12_384_in22k", dropout=args.dropout, loss=args.loss,lr=args.lr,drop_path_rate=args.drop_path_rate,
