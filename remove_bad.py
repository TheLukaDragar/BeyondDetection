...
for run in sweep_runs:
    ...
    if run.summary.get('final_final_score') is not None and run.summary['final_final_score'] < 0.81:
...
for run_id in filtered_run_ids:
    ...
    os.system("rm -rf ./eva_models_images/" + run_id)
