...
class Eva(pl.LightningModule):
    def __init__(self, model_name="swin_large_patch4_window12_384_in22k", dropout=0.1, loss="rmse", lr=2e-5,drop_path_rate=0.0,weight_decay=0.01):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--experiment_name",
        default="eva_large_patch14_336.in22k_ft_in22k_in1k_2",
